export const dataHome = {
  ...
  screen4: {
    ...
    videoList: [
      '/dataSources/4.TCT_van_tai_thuy/GIOI_THIEU_CHUNG_PG_TANKER.mp4',
      '/dataSources/4.TCT_van_tai_thuy/PGTanker_nguoi_cam_co.mp4'
    ],
    name: 'PG Tanker',
    path: '#',
    children: [
      {
        name: 'Giới thiệu PG TANKER',
        path: '/dataSources/4.TCT_van_tai_thuy/GIOI_THIEU_CHUNG_PG_TANKER.mp4'
      },
      {
        name: 'PG TANKER - Người cắm cờ Petrolimex nơi biển xa',
        path: '/dataSources/4.TCT_van_tai_thuy/PGTanker_nguoi_cam_co.mp4'
      }
    ]
  },
  ...
  screen67: {
    ...
    videoList: [
      ...
      '/dataSources/67.Cty_CP_Petrolimex/san_pham_Dau_mo_nhon.mp4',
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            name: 'sản phẩm Dầu mỡ nhờn',
            path: '/dataSources/67.Cty_CP_Petrolimex/san_pham_Dau_mo_nhon.mp4'
          }
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            path: '/dataSources/67.Cty_CP_Petrolimex/nhua_duong_sp.mp4'
          }
        ]
      },
      {
  ...
  screen8: {
    ...
    children: [
      ...
      {
        name: 'Sản xuất, vận chuyển và sản phẩm Gas',
  ...
  screen9: {
    ...
    videoList: [
      '/dataSources/9.ThietBiXangDauPECO/PECO-cac_hinh_anh_sx.mp4',
      '/dataSources/9.ThietBiXangDauPECO/PECO-co_so_vat_chat.mp4',
      '/dataSources/9.ThietBiXangDauPECO/PECO-hoat_dong_sx_kd.mp4',
      '/dataSources/9.ThietBiXangDauPECO/PECO-hinh_anh_cot_bom.mp4'
    ],
    ...
    children: [
      {
        ...
        path: '/dataSources/9.ThietBiXangDauPECO/PECO-cac_hinh_anh_sx.mp4'
      },
      {
        name: 'Cơ sở vật chất',
        path: '/dataSources/9.ThietBiXangDauPECO/PECO-co_so_vat_chat.mp4'
      },
      {
        name: 'Hoạt động sản xuất kinh doanh',
        path: '/dataSources/9.ThietBiXangDauPECO/PECO-hoat_dong_sx_kd.mp4'
      },
      {
        name: 'Hình ảnh sản phẩm',
        path: '/dataSources/9.ThietBiXangDauPECO/PECO-hinh_anh_cot_bom.mp4'
      }
    ]
  }
